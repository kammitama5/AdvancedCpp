...
int main()
{
	...
	cout << "The minimum index in arr1 is: " << maximum(arr1, 3) << endl;
	cout << "The minimum index in arr2 is: " << maximum(arr2, 3) << endl;
	cout << "The minimum index in arr3 is: " << maximum(arr3, 3) << endl;
